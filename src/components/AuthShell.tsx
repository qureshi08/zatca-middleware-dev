...
export default function AuthShell({
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(160deg,#eaf2fb 0%,#f4f7fb 55%,#eef5fc 100%)", padding: 20 }}>
      <div style={{ width: 410 }}>
        <div style={{ textAlign: "center", marginBottom: 18 }}>
          <Link href="/login" style={{ textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 10 }}>
            <span style={{ width: 34, height: 34, borderRadius: 9, background: "#1F6FB2", color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: 17 }}>Z</span>
            <span style={{ fontWeight: 800, color: "#155a93", fontSize: 17, letterSpacing: -0.2 }}>ZATCA Middleware</span>
          </Link>
        </div>
        <div style={{ background: "#fff", border: "1px solid #e3e8ef", borderRadius: 14, padding: "26px 26px 24px", boxShadow: "0 8px 30px rgba(20,90,147,.08)" }}>
...
export const authBtn: React.CSSProperties = { width: "100%", padding: "12px 16px", borderRadius: 9, border: "none", background: "#1F6FB2", color: "#fff", fontSize: 14, fontWeight: 600, cursor: "pointer" };
